...
import 'package:al_sharq_conference/speaker_view/auth/forget_password_view.dart';
import 'package:al_sharq_conference/speaker_view/auth/signup_view.dart';
...
import '../manage_session_speaker/manage_session_speaker.dart';

class SpeakerLoginScreen extends StatefulWidget {
  const SpeakerLoginScreen({super.key});

  @override
  State<SpeakerLoginScreen> createState() => _SpeakerLoginScreenState();
}

class _SpeakerLoginScreenState extends State<SpeakerLoginScreen> {
                  ...
                  children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const SpeakerForgotPasswordScreen(),
                              ),
                            );
                          },
                          child: AppText(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(const SpeakerSignupScreen());
                          },
                          child: AppText(
                            text: "Sign Up",
                            fontSize: 16,
