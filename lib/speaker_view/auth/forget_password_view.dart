...
class SpeakerForgotPasswordScreen extends StatefulWidget {
  const SpeakerForgotPasswordScreen({super.key});

  @override
  State<SpeakerForgotPasswordScreen> createState() => _SpeakerForgotPasswordScreenState();
}

class _SpeakerForgotPasswordScreenState extends State<SpeakerForgotPasswordScreen> {
