...
class SpeakerSignupScreen extends StatefulWidget {
  const SpeakerSignupScreen({super.key});

  @override
  State<SpeakerSignupScreen> createState() => _SpeakerSignupScreenState();
}

class _SpeakerSignupScreenState extends State<SpeakerSignupScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      text: "Create Account",
                      onPressed: () {
                        Get.to(SpeakerSetupProfileScreen());
                      },
                    ),
