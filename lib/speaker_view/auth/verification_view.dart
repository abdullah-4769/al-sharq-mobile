...
import 'package:al_sharq_conference/speaker_view/auth/reset_password_view.dart';
...
class SpeakerVerificationScreen extends StatefulWidget {
  const SpeakerVerificationScreen({super.key});
...
class _SpeakerVerificationScreenState extends State<SpeakerVerificationScreen> {
  ...
  void _verifyCode() {
    if (verificationCode.length == 4) {
      ...
      Get.to(SpeakerResetPasswordScreen());
    } else {
