...
class SponsorProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final profileViewModel = Get.put(SponsorProfileGetViewModel());
    final updateViewModel = Get.put(SponsorProfileUpdateViewModel());
  ...
  Widget _buildProfileContent(SponsorProfileGetModel profile) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // Profile Header
          Center(child: _buildProfileHeader(profile)),
          SizedBox(height: 24),
