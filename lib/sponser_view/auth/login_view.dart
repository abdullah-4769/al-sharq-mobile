...
import 'package:al_sharq_conference/sponser_view/manage_session/manage_session.dart';
...
class SponserLoginScreen extends StatefulWidget {
  const SponserLoginScreen({super.key});

  @override
  State<SponserLoginScreen> createState() => _SponserLoginScreenState();
}

class _SponserLoginScreenState extends State<SponserLoginScreen> {
