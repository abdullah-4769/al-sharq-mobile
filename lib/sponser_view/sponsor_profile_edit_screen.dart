import 'package:al_sharq_conference/sponser_view/represenative_view/sponsor_add_representative_widget.dart';
import 'package:al_sharq_conference/sponser_view/represenative_view/sponsor_show_representatives_widget.dart';
...
class _SponsorProfileEditScreenState extends State<SponsorProfileEditScreen> {
  ...
  void initState() {
    ...
    Get.put(SponsorRepresentativeViewModel());
  ...
  void _loadRepresentatives() {
    final representativeViewModel = Get.find<SponsorRepresentativeViewModel>();
    representativeViewModel.loadSponsorRepresentatives(widget.profile.id);
  }
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            // Representatives Management Section - ADDED ABOVE PRODUCTS
  ...
  // Add this new method for Representatives Section
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          AppText(
            text: 'Manage your company representatives',
            fontSize: 14,
            color: AppColors.darkgrey,
          ),
          SizedBox(height: 20),

          // Add Representative Widget
          SponsorAddRepresentativeWidget(
            sponsorId: widget.profile.id,
            onRepresentativeAdded: _loadRepresentatives,
          ),
          SizedBox(height: 24),

          // Show Representatives Widget
          SponsorShowRepresentativesWidget(sponsorId: widget.profile.id),
        ],
      ),
    );
  }
