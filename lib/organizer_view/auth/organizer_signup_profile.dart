...
class OrganizerSignupProfile extends StatefulWidget {
  const OrganizerSignupProfile({super.key});

  @override
  State<OrganizerSignupProfile> createState() => _OrganizerSignupProfileState();
}

class _OrganizerSignupProfileState extends State<OrganizerSignupProfile> {
