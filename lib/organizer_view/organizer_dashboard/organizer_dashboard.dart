import 'package:al_sharq_conference/notifications/notification_screen.dart';
        ...
        actions: [
          ...
          Stack(
            children: [
              InkWell(
                onTap: () {
                  print('🔔 [Dashboard] Notification icon tapped');
              ...
              // ========== NOTIFICATION BADGE ==========
              Obx(() {
                final notificationCount = Get.find<NotificationController>().notifications.length;

                if (notificationCount == 0) {
                  return const SizedBox.shrink(); // Hide badge if no notifications
                }
