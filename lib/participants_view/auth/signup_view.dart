...
// ==================== SIGNUP SCREEN WITH OTP ====================
/// Updated signup screen that sends OTP for email verification
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signupWithOTP() async {
    ...
    // Call signup with OTP verification
    await _viewModel.signupWithOTP(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    /// Info Text - No Password Required
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'We\'ll send a verification code to your email. You\'ll set your password after verification.',
                              style: TextStyle(
                                fontSize: 12,
                    ...
                    Obx(() => CustomButton(
                      text: _viewModel.isLoading.value
                          ? "Creating Account..."
                          : "Create Account",
                      isLoading: _viewModel.isLoading.value,
                      onPressed: _viewModel.isLoading.value ? null : _signupWithOTP,
                    )),
