...
class OrganizerDashboardSmallDetailShowRepo {
  final String baseUrl = ApiConstants.baseUrl;

  Future<OrganizerDashboardSmallDetailShowModel> getDashboardData() async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        return OrganizerDashboardSmallDetailShowModel.fromJson(responseData);
