class SpeakerDashboardShowModel {
  final int id;
  final int userId;
  ...
  factory SpeakerDashboardShowModel.fromJson(Map<String, dynamic> json) {
    return SpeakerDashboardShowModel(
      id: json['id'] ?? 0,
